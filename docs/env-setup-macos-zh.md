...
```
~/.cc-switch/runtime/claude/bin/claude --version
~/.cc-switch/runtime/codex/bin/codex --version
```
...
2. 删除 `~/.cc-switch/runtime/claude/` 或 `~/.cc-switch/runtime/codex/` 里的 npm prefix 内容
